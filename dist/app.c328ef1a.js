...
var records = JSON.parse("{\r\n  \"names\": [\r\n    \"facebook\"\r\n  ],\r\n  \"records\": [\r\n    {\r\n      \"name\": \"facebook\",\r\n      \"intent\": \"facebookIntent\",\r\n      \"kbid\": \"2d35fc03-b906-41d8-810e-e84c06f45df2\"\r\n    }\r\n  ]\r\n}"); //console.log(obj);
...
async function query() {
  ...
  node.appendChild(textInNode); //append user message

  var screendiv = document.getElementById("screen");
  screendiv.appendChild(node); //append line breaks
  ...
  */
  ...
  var luisIntentScore = luisIntentResponse.prediction.intents[luisIntent]["score"];
  var kbid;
  ...
  console.log(serverResponse); //append server message

  var servernode = document.createElement("div");
  servernode.className = "servermessage";
  var serverTextInNode = document.createTextNode(serverResponse.answers[0].answer);
  servernode.appendChild(serverTextInNode); //append user message
...
async function getAnswer(kbid, current_question) {
  ...
  try {
    var url = "https://privacyoracle.azurewebsites.net/qnamaker/knowledgebases/" + kbid + "/generateAnswer";
...
async function getIntent(current_question) {
  try {
    var url = "https://westus.api.cognitive.microsoft.com/luis/prediction/v3.0/apps" + "/acd7e09e-259e-47de-ac1a-16c763e43f30/slots/production/predict?verbose=true&timezoneOffset=0" + "&subscription-key=12d23ac95af1478984b44d5f77ec122f&query=" + current_question + "&show-all-intents=true"; //const data = await postData(url, { answer: 42 });
...
},{"fs":"../node_modules/parcel/src/builtins/_empty.js"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
